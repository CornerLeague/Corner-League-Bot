...
class URLCanonicalizer:
    ...
    def extract_canonical_from_html(self, html_content: str, base_url: str) -> Optional[str]:
...
class ContentExtractor:
        ...
        try:
            ...
            for method_name, method_func in extraction_methods:
                try:
                    ...
                    result['extraction_errors'].append(f"{method_name}: {str(e)}")
            ...
            result['extraction_errors'].append(f"General error: {str(e)}")
            return result
    ...
    def _classify_content_type(self, title: str, text: str) -> Optional[str]:
